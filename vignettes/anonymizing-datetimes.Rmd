...
vignette: >
  %\VignetteIndexEntry{Anonymizing Dates and Times in VOL Files}
...
anon_dob <- as.POSIXct(0, origin = "1970-01-01", tz = "UTC")    # FAILS
...
anon_dob_good <- as.POSIXct(0, origin = "1970-01-01", tz = "UTC")
